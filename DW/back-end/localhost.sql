...
--
-- Hôte : localhost:3306
-- Généré le : ven. 23 juil. 2021 à 10:08
...
CREATE TABLE `clients` (
  ...
  `clien_nom` varchar(50) DEFAULT NULL,
  `clien_prenom` varchar(50) DEFAULT NULL,
  `clien_ref` decimal(10,0) DEFAULT NULL,
  `clien_age` int(11) DEFAULT NULL,
  `clien_sex` varchar(10) DEFAULT NULL,
...
CREATE TABLE `commande` (
  ...
  `com_ref` decimal(10,0) DEFAULT NULL,
  `com_produit` varchar(100) DEFAULT NULL,
  `com_qte` decimal(10,0) DEFAULT NULL,
  `com_prix` decimal(10,0) DEFAULT NULL,
  `com_nom` varchar(50) DEFAULT NULL,
  `com_nom_vendeur` varchar(50) DEFAULT NULL,
...
CREATE TABLE `produits` (
  ...
  `pro_qte` decimal(10,0) DEFAULT NULL,
  `pro_prix` decimal(10,0) DEFAULT NULL,
  `servi_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Structure de la table `service_vehicules`
--

CREATE TABLE `service_vehicules` (
  `servi_id` int(11) NOT NULL,
  `servi_réparation` tinyint(1) DEFAULT NULL,
  `servi_datetime` decimal(10,0) NOT NULL,
  `servi_ref` varchar(50) DEFAULT NULL,
  `servi_nom` varchar(50) DEFAULT NULL,
  `servi_prix` decimal(10,0) NOT NULL,
  `servi_qté` decimal(10,0) NOT NULL,
  `voi_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Structure de la table `vente_particuliers_ou_utilitaires`
--

CREATE TABLE `vente_particuliers_ou_utilitaires` (
  `vent_ref` varchar(50) NOT NULL,
  `vent_lib` varchar(50) DEFAULT NULL,
  `vent_prix` decimal(10,0) NOT NULL,
  `vent_descrip` longtext,
  `vent_credit` tinyint(1) DEFAULT NULL,
  `vent_comptemptant` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `voiture` (
  ...
  `voi_lib` varchar(50) DEFAULT NULL,
  `voi_prix` decimal(10,0) NOT NULL,
  `voi_descrip` longtext,
  `voi_credit` tinyint(1) DEFAULT NULL,
  `voi_neuf` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Index pour la table `emploiye`
--
ALTER TABLE `emploiye`
  ADD PRIMARY KEY (`emp_id`),
  ADD KEY `servi_id` (`servi_id`);
...
--
-- Index pour la table `service_vehicules`
--
ALTER TABLE `service_vehicules`
...
--
-- AUTO_INCREMENT pour la table `emploiye`
--
ALTER TABLE `emploiye`
...
--
-- AUTO_INCREMENT pour la table `service_vehicules`
--
ALTER TABLE `service_vehicules`
...
--
ALTER TABLE `voiture`
  MODIFY `voi_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `clients`
  ADD CONSTRAINT `clients_ibfk_1` FOREIGN KEY (`emp_id`) REFERENCES `emploiye` (`emp_id`);

--
-- Contraintes pour la table `commande`
--
ALTER TABLE `commande`
  ADD CONSTRAINT `commande_ibfk_1` FOREIGN KEY (`clien_id`) REFERENCES `clients` (`clien_id`);

--
-- Contraintes pour la table `emploiye`
--
ALTER TABLE `emploiye`
  ADD CONSTRAINT `emploiye_ibfk_1` FOREIGN KEY (`servi_id`) REFERENCES `service_vehicules` (`servi_id`);

--
-- Contraintes pour la table `produits`
--
ALTER TABLE `produits`
  ADD CONSTRAINT `produits_ibfk_1` FOREIGN KEY (`servi_id`) REFERENCES `service_vehicules` (`servi_id`);

--
-- Contraintes pour la table `service_vehicules`
--
ALTER TABLE `service_vehicules`
  ADD CONSTRAINT `service_vehicules_ibfk_1` FOREIGN KEY (`voi_id`) REFERENCES `voiture` (`voi_id`);
--
-- Base de données : `gescomstruct.`
--
CREATE DATABASE IF NOT EXISTS `gescomstruct.` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `gescomstruct.`;
...
--
ALTER TABLE `orders_details`
  MODIFY `ode_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `posts`
  MODIFY `pos_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
ALTER TABLE `chambre`
  ...
  ADD KEY `chambre_hotel_FK` (`num_hotel`);
...
ALTER TABLE `hotel`
  ...
  ADD KEY `hotel_station_FK` (`num_station`);

--
-- Index pour la table `reservation`
--
ALTER TABLE `reservation`
  ADD PRIMARY KEY (`num_chambre`,`num_client`),
  ADD KEY `reservation_client_FK` (`num_client`);
...
--
ALTER TABLE `chambre`
  ADD CONSTRAINT `chambre_hotel_FK` FOREIGN KEY (`num_hotel`) REFERENCES `hotel` (`num_hotel`);

--
-- Contraintes pour la table `hotel`
--
ALTER TABLE `hotel`
  ADD CONSTRAINT `hotel_station_FK` FOREIGN KEY (`num_station`) REFERENCES `station` (`num_station`);

--
-- Contraintes pour la table `reservation`
--
ALTER TABLE `reservation`
  ADD CONSTRAINT `reservation_client_FK` FOREIGN KEY (`num_client`) REFERENCES `client` (`num_client`),
  ADD CONSTRAINT `resrvation_chambre_FK` FOREIGN KEY (`num_chambre`) REFERENCES `chambre` (`num_chambre`);
--
...
(70010, '', '2018-04-28 13:59:51', 120),
(70011, 'comende urgente', '2018-04-23 13:59:51', 540),
(70020, NULL, '2018-04-23 13:59:51', 9120),
(70025, 'commande irgente ', '2018-04-23 13:59:51', 9150),
(70210, 'commende cadencée', '2018-04-23 13:59:51', 120),
(70250, 'commende cadencée ', '2018-04-01 13:59:51', 8700),
(70300, NULL, '2018-04-23 13:59:51', 120),
(70620, NULL, '2018-04-23 13:59:51', 540);
...
(120, 'GROBRIGAN', '20 rue du papier ', '92200', 'paper city', 'Gorges', 8),
(540, 'ECLIPSE', '53 rue laisse flotter les rubans ', '78250', 'Bugbugville', 'Nestore', 7),
(1200, 'GROBRIGAN', '20 rue du papier ', '92200', 'paper city', 'Gorges', 8),
(5400, 'ECLIPSE', '53 rue laisse flotter les rubans ', '78250', 'Bugbugville', 'Nestore', 7),
(8700, 'MEDICIS', '120 rue des plantes', '75014', 'Paris', 'Lison', 0),
(9120, 'DISCOBOL', '11 rue des sports', '85100', 'La Roche sur Yon', 'Hercule', 8),
(9150, 'DEPANPAP', '26 avenue des locomotives', '59987', 'Cotoncountry', 'Pollux', 5),
(9180, 'HURRYTAPE', '68 boulevard des octets', '4044', 'Dumpvill', 'Track', 0),
(87000, 'MEDICIS', '120 rue des plantes', '75014', 'Paris', 'Lison', 0),
(91050, 'DEPANPAP', '26 avenue des locomotives', '59987', 'Cotoncountry', 'Pollux', 5),
(91200, 'DISCOBOL', '11 rue des sports', '85100', 'La Roche sur Yon', 'Hercule', 8),
(91800, 'HURRYTAPE', '68 boulevard des octets', '4044', 'Dumpvill', 'Track', 0);
...
CREATE TABLE `produit` (
  ...
  `stkale` int(50) NOT NULL,
  `stkphy` int(50) NOT NULL,
  `qteann` int(50) NOT NULL,
  `unimes` char(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `vente01`
--

CREATE TABLE `vente01` (
  `codart` char(4) NOT NULL,
  `numfou` int(11) NOT NULL,
  `delliv` smallint(6) NOT NULL,
  `qte1` int(11) NOT NULL,
...
--
ALTER TABLE `entcom`
  MODIFY `numcom` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70621;
...
(11, 'James Jameson', 'james1965@example.com', '4002349823', 'Assistant', '2019-05-09 19:32:00'),
(12, 'Daniel Deacon', 'danieldeacon@example.com', '5003423549', 'Manager', '2019-05-09 19:33:00'),
(14, '', '', '', '', '2021-06-29 14:08:00'),
(15, '', '', '', '', '2021-06-29 14:08:00'),
(16, '', '', '', '', '2021-06-29 14:11:00'),
(17, '', '', '', '', '2021-06-29 14:11:00'),
(18, '', '', '', '', '2021-06-29 14:11:00'),
(19, '', '', '', '', '2021-06-29 14:13:00'),
(20, '', '', '', '', '2021-06-29 14:13:00'),
(21, '', '', '', '', '2021-06-29 14:14:00'),
(22, '', '', '', '', '2021-06-29 14:15:00'),
(23, '', '', '', '', '2021-06-29 14:15:00'),
(24, '', '', '', '', '2021-06-29 14:15:00'),
(25, '', '', '', '', '2021-06-29 14:15:00'),
(26, '', '', '', '', '2021-06-29 14:20:00');
